        ...
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden; margin-top: 20px;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background: #f8f4f0; border-radius: 8px; padding: 20px; margin: 20px 0;">
              <p style="margin: 0; color: #1a1a2e; font-size: 14px;"><strong>Order Number:</strong> ${orderNumber}</p>
              <p style="margin: 8px 0 0; color: #1a1a2e; font-size: 14px;"><strong>Total:</strong> $${total}</p>
            </div>
            <p style="color: #555; line-height: 1.6; font-size: 16px;">
              We'll send you another email when your order ships with tracking information.
            </p>
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.APP_URL}/orders" style="background: #d4af37; color: #1a1a2e; padding: 14px 32px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">
                View Order
              </a>
            </div>
          </div>
